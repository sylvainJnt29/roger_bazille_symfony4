...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        // $questionTest->setCreatedAt(new \DateTime('now'))
        //                 ->setTitre("Projet nettoyer la rue")
        //                 ->setQuestion("Je voudrais savoir si on pourrais organiser un collectif pour aller nettoyer la rue devant l'école?.")
        //                 ->setUtilisateurs($utilisateur1);
        // $manager->persist($questionTest);
    ...
    $actuProf2 = new Actu();
        ...
        $actuTap3->setCreatedAt(new \DateTime('09-09-2019'))
                ...
                Issu d'Amérique latine où il est traditionnellement fabriqué, il aurait été popularisé par les travellers qui en 
                auraient transmis la technique au gré de leurs voyages. ")
